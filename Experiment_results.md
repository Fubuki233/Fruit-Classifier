...
## 1. Experiment Summary on Models

| Exp ID | Notebook / Script     | Model Settings Description         | Data augmentation | Dropout | Val Acc | Test Acc | Notes |
|-------|------------------------|------------------------------------|-------------------|---------|---------|----------|-------|
...
## 2. Experiment Summary for Models on test.data
