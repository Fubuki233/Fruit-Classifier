...
| E2     | [E2_augmentation_light.py](E2_augmentation_light.py)     | Basic CNN                          | Rotation + Flip                   | None                |           |         |     Test Accuracy: 90.00%     | Light augmentation |
| E3     | [E3_augmentation_heavy.py](E3_augmentation_heavy.py)     | Basic CNN                          | Rotation + Shift + Zoom + Brightness | None           |           |         |          | Heavy augmentation | Test Accuracy: 91.67%
...
| E9     | [E9_color_boost.py](E9_color_boost.py)     | Basic CNN (3 Conv layers)      | Moderate geo + brightness [0.7-1.3] + channel shift    | Dropout (0.2/0.2)       |           |  Test Accuracy: 88.33%    |   
| E10    | [E10_mixed.py](E10_mixed.py) | Basic CNN (3 Conv layers) | Intensive mix: strong geo + brightness [0.5-1.5] + channel shift | Dropout (0.2/0.2) |        |         |          |  Test Accuracy: 86.67% |
