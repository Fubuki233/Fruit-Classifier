...
| E9     | [E9_color_boost.py](E9_color_boost.py)     | Basic CNN (3 Conv layers)      | Moderate geo + brightness [0.7-1.3] + channel shift    | Dropout (0.2/0.2)       |           |      |   
| E10    | [E10_mixed.py](E10_mixed.py) | Basic CNN (3 Conv layers) | Intensive mix: strong geo + brightness [0.5-1.5] + channel shift | Dropout (0.2/0.2) |        |         |          |  |
